...
def main():
    ...
    audio_list='/Users/ashisharora/Desktop/chime6/chime6_transcriptions/audio_list'
    trans_dir = '/Users/ashisharora/Desktop/chime6/chime6_transcriptions/dev'
    ...
    for i, audio in enumerate(wav_list):
        ...
        utt2spk_file = '/Users/ashisharora/Desktop/chime6/output2/' + session
